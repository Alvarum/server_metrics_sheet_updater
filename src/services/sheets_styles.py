"""
Módulo de definiciones de estilos y formatos.
"""

from typing import Dict, Any

RAPTOR_BLUE = {"red": 0.258, "green": 0.52, "blue": 0.956}
...
STYLES: Dict[str, Dict[str, Any]] = {
    ...
    "METADATA_LABEL": {
        ...
        "textFormat": {"foregroundColor": WHITE, "bold": True, "fontSize": 10},
        "horizontalAlignment": "RIGHT", "verticalAlignment": "MIDDLE",
        "borders": {"bottom": {"style": "SOLID", "color": WHITE}, "top": {"style": "SOLID", "color": WHITE}, "left": {"style": "SOLID", "color": WHITE}, "right": {"style": "SOLID", "color": WHITE}}
    },
    "METADATA_VALUE": {
        "backgroundColor": WHITE,
        "textFormat": {"foregroundColor": BLACK, "bold": True},
        "horizontalAlignment": "CENTER", "verticalAlignment": "MIDDLE",
        "borders": {"bottom": {"style": "SOLID", "color": BLACK}, "top": {"style": "SOLID", "color": BLACK}, "left": {"style": "SOLID", "color": BLACK}, "right": {"style": "SOLID", "color": BLACK}}
    },
    "TABLE_BASE": {
        "borders": {"top": {"style": "SOLID"}, "bottom": {"style": "SOLID"}, "left": {"style": "SOLID"}, "right": {"style": "SOLID"}},
        "textFormat": {"foregroundColor": BLACK}, "verticalAlignment": "MIDDLE"
    },
    "ALERT_RED": {
...
CONDITION_MAP: Dict[str, str] = {
    ...
    "==": "TEXT_EQ",
    "between": "NUMBER_BETWEEN", "not_between": "NUMBER_NOT_BETWEEN",
}